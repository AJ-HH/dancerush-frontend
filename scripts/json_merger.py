...
os.chdir(os.getcwd())
file_path_1 = 'C:\\Users\\Andrew\\projects\\dancerush stuff\\dancerush-frontend\\public\\dancerush_songs.json'
file_path_2 = 'C:\\Users\\Andrew\\projects\\dancerush stuff\\dancerush-frontend\\public\\botsjson.json'
...
df2 = df2.drop('alias', axis=1)
df2 = df2.drop('artistalias', axis=1)
